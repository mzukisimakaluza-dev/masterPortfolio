...
const skills = {
  data: [
    ...
    },
    {
      ...
      skills: [
        "⚡ Building responsive website front end using VueJS",
        "⚡ Creating application backend in Node, Express & Mongo or Elasticsearch",
        "⚡ Linux-based microservices with C/C++"
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
